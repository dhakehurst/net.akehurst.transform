...
public class Uml2Rdbms_Class2Table_Test extends AbstractTransformTest {
	...
	@Test
	public void enforce_uml__class_table_same() {
		...
		this.testEnforce(Uml2Rdbms.umlDomainId, uml, rdbms, true, true);
		
	}

	@Test
	public void enforce_rdbms__class_table_same() {
		simpleUml.Package p = simpleUml.SimpleUmlFactory.createPackage();
		p.setName("addressBook");
		simpleUml.Class c1 = simpleUml.SimpleUmlFactory.createClass();
		c1.setName("Contact");
		...
		this.testEnforce(Uml2Rdbms.rdbmsDomainId, uml, rdbms, true, true);

	}

	@Test
	public void enforce_rdbms__class_table_different() {
		simpleUml.Package p = simpleUml.SimpleUmlFactory.createPackage();
		p.setName("addressBook");
		simpleUml.Class c1 = simpleUml.SimpleUmlFactory.createClass();
		c1.setName("Contact");
		...
		this.testEnforce(Uml2Rdbms.rdbmsDomainId, uml, rdbms, false, true);
